...
c
     ...
     &                 +(om2r(x,y1,z,i)**2+om2i(x,y1,z,i)**2)*c*2
            ...
            if (nfzsym.eq.0) then
               do z=nzp-nz/2+2,nzp
                  amp(y,i)=amp(y,i)+
     &                 u2r(1,y1,z,i)**2+u2i(1,y1,z,i)**2
                  amp(y,i+3)=amp(y,i+3)+
     &                 om2r(1,y1,z,i)**2+om2i(1,y1,z,i)**2
               end do
               do z=nzp-nz/2+2,nzp
                  do x=2,nx/2
                     amp(y,i)=amp(y,i)
...
c
     ...
     &           u2i(x,y1,1,1) * u2i(x,y1,1,2) )
            ...
            amp(y,14)=amp(y,14)+2*(
     &           u2r(x,y1,1,1) * u2r(x,y1,1,3) +
     &           u2i(x,y1,1,1) * u2i(x,y1,1,3) )
            amp(y,15)=amp(y,15)+2*(
     &           u2r(x,y1,1,2) * u2r(x,y1,1,3) +
     &           u2i(x,y1,1,2) * u2i(x,y1,1,3) )
            amp(y,16)=amp(y,16)+2*(
     &           u2r(x,y1,1,1) * u2r(x,y1,1,1) +
     &           u2i(x,y1,1,1) * u2i(x,y1,1,1) )
            amp(y,17)=amp(y,17)+2*(
     &           u2r(x,y1,1,2) * u2r(x,y1,1,2) +
     &           u2i(x,y1,1,2) * u2i(x,y1,1,2) )
            amp(y,18)=amp(y,18)+2*(
     &           u2r(x,y1,1,3) * u2r(x,y1,1,3) +
     &           u2i(x,y1,1,3) * u2i(x,y1,1,3) )
     ...
     &           u2i(1,y1,z,1) * u2i(1,y1,z,2) )
            ...
            amp(y,14)=amp(y,14)+c*(
     &           u2r(1,y1,z,1) * u2r(1,y1,z,3) +
     &           u2i(1,y1,z,1) * u2i(1,y1,z,3) )
            amp(y,15)=amp(y,15)+c*(
     &           u2r(1,y1,z,2) * u2r(1,y1,z,3) +
     &           u2i(1,y1,z,2) * u2i(1,y1,z,3) )
            amp(y,16)=amp(y,16)+c*(
     &           u2r(1,y1,z,1) * u2r(1,y1,z,1) +
     &           u2i(1,y1,z,1) * u2i(1,y1,z,1) )
            amp(y,17)=amp(y,17)+c*(
     &           u2r(1,y1,z,2) * u2r(1,y1,z,2) +
     &           u2i(1,y1,z,2) * u2i(1,y1,z,2) )
            amp(y,18)=amp(y,18)+c*(
     &           u2r(1,y1,z,3) * u2r(1,y1,z,3) +
     &           u2i(1,y1,z,3) * u2i(1,y1,z,3) )
     ...
     &              u2i(x,y1,z,1) * u2i(x,y1,z,2) )
               ...
               amp(y,14)=amp(y,14)+2*c*(
     &              u2r(x,y1,z,1) * u2r(x,y1,z,3) +
     &              u2i(x,y1,z,1) * u2i(x,y1,z,3) )
               amp(y,15)=amp(y,15)+2*c*(
     &              u2r(x,y1,z,2) * u2r(x,y1,z,3) +
     &              u2i(x,y1,z,2) * u2i(x,y1,z,3) )
               amp(y,16)=amp(y,16)+2*c*(
     &              u2r(x,y1,z,1) * u2r(x,y1,z,1) +
     &              u2i(x,y1,z,1) * u2i(x,y1,z,1) )
               amp(y,17)=amp(y,17)+2*c*(
     &              u2r(x,y1,z,2) * u2r(x,y1,z,2) +
     &              u2i(x,y1,z,2) * u2i(x,y1,z,2) )
               amp(y,18)=amp(y,18)+2*c*(
     &              u2r(x,y1,z,3) * u2r(x,y1,z,3) +
     &              u2i(x,y1,z,3) * u2i(x,y1,z,3) )
     ...
     &              u2i(1,y1,zp,1) * u2i(1,y1,zp,2)
               ...
               amp(y,14)=amp(y,14)+ 
     &              u2r(1,y1,zp,1) * u2r(1,y1,zp,3) +
     &              u2i(1,y1,zp,1) * u2i(1,y1,zp,3)
               amp(y,15)=amp(y,15)+ 
     &              u2r(1,y1,zp,2) * u2r(1,y1,zp,3) +
     &              u2i(1,y1,zp,2) * u2i(1,y1,zp,3)
               amp(y,16)=amp(y,16)+ 
     &              u2r(1,y1,zp,1) * u2r(1,y1,zp,1) +
     &              u2i(1,y1,zp,1) * u2i(1,y1,zp,1)
               amp(y,17)=amp(y,17)+ 
     &              u2r(1,y1,zp,2) * u2r(1,y1,zp,2) +
     &              u2i(1,y1,zp,2) * u2i(1,y1,zp,2)
               amp(y,18)=amp(y,18)+ 
     &              u2r(1,y1,zp,3) * u2r(1,y1,zp,3) +
     &              u2i(1,y1,zp,3) * u2i(1,y1,zp,3)
            end do
            do z=nz/2+2,nz
               do x=2,nx/2
                  zp=nzp-nz+z
                  amp(y,7)=amp(y,7)+
     &                 (om2r(x,y1,zp,2)**2+om2i(x,y1,zp,2)**2)/
     &                 (alfa(x)**2+beta(z)**2)*2.
                  amp(y,8)=amp(y,8)+2*(
     ...
     &                 u2i(x,y1,zp,1) * u2i(x,y1,zp,2) )
                  ...
                  amp(y,14)=amp(y,14)+2*(
     &                 u2r(x,y1,zp,1) * u2r(x,y1,zp,3) +
     &                 u2i(x,y1,zp,1) * u2i(x,y1,zp,3) )
                  amp(y,15)=amp(y,15)+2*(
     &                 u2r(x,y1,zp,2) * u2r(x,y1,zp,3) +
     &                 u2i(x,y1,zp,2) * u2i(x,y1,zp,3) )
                  amp(y,16)=amp(y,16)+2*(
     &                 u2r(x,y1,zp,1) * u2r(x,y1,zp,1) +
     &                 u2i(x,y1,zp,1) * u2i(x,y1,zp,1) )
                  amp(y,17)=amp(y,17)+2*(
     &                 u2r(x,y1,zp,2) * u2r(x,y1,zp,2) +
     &                 u2i(x,y1,zp,2) * u2i(x,y1,zp,2) )
                  amp(y,18)=amp(y,18)+2*(
     &                 u2r(x,y1,zp,3) * u2r(x,y1,zp,3) +
     &                 u2i(x,y1,zp,3) * u2i(x,y1,zp,3) )
               end do
            end do
         end if
      end do

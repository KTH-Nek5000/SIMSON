...
c
  ...
  103   continue
      ...
      parameter (taur=-.5,taui=.86602540378443864676)
      if (ido .eq. 1) then
        do 101 k=1,l1
        do 101 j=1,m
...
C          ci4 = ti1-ti4
  ...
  103   continue
     ...
     & wa1,wa2,wa3,wa4)
      ...
      parameter(tr11= .30901699437494742410)
      parameter(ti11= .95105651629515357212)
      parameter(tr12=-.80901699437494742410)
      parameter(ti12= .58778525229247312917)
...
C          di6 = ci5-cr6
  ...
  103   continue
     ...
     & wa1,wa2,wa3,wa4,wa5,wa6,wa7)
      ...
      parameter (w=.70710678118654752440)
      if (ido .eq. 1) then
        do 101 k=1,l1
        do 101 j=1,m
...
C          di6 = ci5-cr6
  ...
  103   continue
      ...
      parameter (tpi = 6.2831853071795864769)
      ifail=0
      nl = n
      nf = 0
      nfac(6)=0
...
cvd$g nolstval
      ...
      parameter(sqrt3=1.7320508075688772935)
      if (n.eq.1) then
...
C          ti4 = 2.*cci(jj,2,2*k)
 ...
 103    continue
      ...
      real sqrt2
      parameter (sqrt2=1.4142135623730950488)
...
C         tr2 = ccr(jj,ido/2+1,1,k)+ccr(jj,ido/2+1,3,k)
  ...
  106 continue
     ...
     &wa1,wa2,wa3,wa4)
      ...
      parameter(tr12=-.80901699437494742410)
      parameter(ti12= .58778525229247312917)
      parameter(tr13=1.1180339887498948482)
...
C          ci2 = di2+di3
 ...
 103    continue
      ...
      real wa1(1),wa2(1),wa3(1)
      real hsqt2
      parameter (hsqt2=.70710678118654752440)
      do 101 k=1,l1
      do 101 j=1,m
         jj=1+jmp*(j-1)
...
C            tr3 = ccr(jj,i,k,1)-cr3
  ...
  107 return
     ...
     &                  wa1,wa2,wa3,wa4)
      ...
      parameter(tr12=-.80901699437494742410)
      parameter(ti12= .58778525229247312917)
      parameter(tr13= .55901699437494742410)
      do 101 k=1,l1
      do 101 j=1,m
        jj=1+jmp*(j-1)
